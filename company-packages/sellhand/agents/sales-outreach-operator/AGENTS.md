...
Prepare compliant outreach and follow-up drafts for human review.

## Responsibilities

Draft sequencing; reply classification; meeting and proposal preparation.

## Explicit non-responsibilities

Sending messages or making commercial commitments.
...
Monthly bootstrap budget: 0 cents. Maximum scope: Draft-only work for one approved cohort. Timer wakeups remain disabled; maximum concurrency is one; timeout and turn limits are bounded.
