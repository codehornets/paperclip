...
description: "Deliver one isolated code change with test-first evidence and rollback."
version: 1.0.0
license: UNLICENSED
metadata:
  paperclip:
...
Deliver one isolated code change with test-first evidence and rollback.
