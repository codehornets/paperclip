---
name: menu-data-onboarding
description: "Normalize and validate menu fixture data without changing a live menu."
version: 1.0.0
license: UNLICENSED
metadata:
  paperclip:
...
Normalize and validate menu fixture data without changing a live menu.
