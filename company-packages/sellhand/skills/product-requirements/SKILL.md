...
description: "Produce testable product requirements with tenant and safety constraints."
version: 1.0.0
license: UNLICENSED
metadata:
  paperclip:
...
Produce testable product requirements with tenant and safety constraints.
