...
description: "Create a budget-bounded campaign proposal requiring approval before launch."
version: 1.0.0
license: UNLICENSED
metadata:
  paperclip:
...
Create a budget-bounded campaign proposal requiring approval before launch.
