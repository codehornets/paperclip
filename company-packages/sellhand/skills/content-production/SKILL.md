...
description: "Produce bilingual content artifacts from an approved brief without publishing."
version: 1.0.0
license: UNLICENSED
metadata:
  paperclip:
...
Produce bilingual content artifacts from an approved brief without publishing.
